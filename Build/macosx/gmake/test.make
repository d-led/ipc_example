...
ifeq ($(config),debug_x32)
  ...
  DEFINES += -D_DEBUG
  INCLUDES += -I../../../src/example -I../../../deps/cppzmq -I../../../deps/cppnanomsg -I/usr/local/Cellar/zeromq/4.1.4/include -I/usr/local/Cellar/nanomsg/0.8-beta/include
  FORCE_INCLUDE +=
  ...
  LIBS += -lzmq -lnanomsg
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -L/usr/local/Cellar/zeromq/4.1.4/lib -L/usr/local/Cellar/nanomsg/0.8-beta/lib -m32
...
ifeq ($(config),debug_x64)
  ...
  LIBS += -lzmq -lnanomsg
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -L/usr/local/Cellar/zeromq/4.1.4/lib -L/usr/local/Cellar/nanomsg/0.8-beta/lib -m64
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x32)
  ...
  LIBS += -lzmq -lnanomsg
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib32 -L/usr/local/Cellar/zeromq/4.1.4/lib -L/usr/local/Cellar/nanomsg/0.8-beta/lib -m32 -Wl,-x
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_x64)
  ...
  LIBS += -lzmq -lnanomsg
  LDDEPS +=
  ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -L/usr/local/Cellar/zeromq/4.1.4/lib -L/usr/local/Cellar/nanomsg/0.8-beta/lib -m64 -Wl,-x
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
